...
export interface IDriverAnyExport {
    /**
     * 向外主动暴露的推动步骤下一步方法
     */
...
export type TDriverDirection = "top" | "bottom" | "left" | "right";

export type TDriverAny = new (config?: IDriverConfig) => IDriverAnyExport

declare global {
    interface Window {
        DriverAny: TDriverAny;
    }
}